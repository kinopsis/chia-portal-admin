                  ...
                  <div className="flex items-center justify-between p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">{dependencia.nombre} - Alcaldía de Chía</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-4">
                      <div className="flex space-x-2">
                  ...
                  <div className="border-t border-gray-200 bg-gray-50">
                    <div className="p-6 space-y-4">
                      {dependencia.subdependencias.map(subdependencia => (
                        <div key={subdependencia.id} className="bg-white rounded-lg border">
                            ...
                            <div className="flex items-center justify-between p-4">
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-600">{subdependencia.sigla || subdependencia.nombre}</p>
                                </div>
                              </div>
                              <div className="flex items-center space-x-3">
                          ...
                          {expandedSubdependencia === subdependencia.id && (
                            <div className="border-t border-gray-200 p-4 bg-gray-50">
                              ...
                              {subdependencia.tramites && subdependencia.tramites.length > 0 && (
                                <div className="mb-4">
                                  <h6 className="font-semibold text-gray-900 mb-2">TRÁMITES:</h6>
                                  <div className="space-y-2">
                                    {subdependencia.tramites.map(tramite => (
                                      <div key={tramite.id} className="flex items-center justify-between bg-white p-3 rounded border">
                                        <div>
                                          <h6 className="font-medium text-gray-900">
                                            📄 [{tramite.codigo_unico}] {tramite.nombre}
                                          </h6>
                                          <p className="text-sm text-gray-600">{tramite.formulario || 'Trámite disponible'}</p>
                                          {tramite.tiene_pago && (
                                            <p className="text-sm text-primary-green">
                                              💰 Con pago | ⏱️ {tramite.tiempo_respuesta || 'Consultar'}
                                            </p>
                                          )}
                                        </div>
                              ...
                              {subdependencia.opas && subdependencia.opas.length > 0 && (
                                <div>
                                  <h6 className="font-semibold text-gray-900 mb-2">OPAS:</h6>
                                  <div className="space-y-2">
                                    {subdependencia.opas.map(opa => (
                                      <div key={opa.id} className="flex items-center justify-between bg-white p-3 rounded border">
                                        <div>
                                          <h6 className="font-medium text-gray-900">
                                            ⚡ [{opa.codigo_opa}] {opa.nombre}
                                          </h6>
                                          <p className="text-sm text-gray-600">OPA disponible</p>
                                        </div>
                                        <Button size="sm" variant="outline">
                                          Ver detalles →
                                        </Button>
