...
const TestTramitesPage: React.FC = () => {
  ...
  const formFields: FormField[] = [
    ...
    },
    {
      ...
      label: 'Visualización SUIT',
      type: 'text',
      placeholder: 'Información para SUIT...',
    },
    {
      name: 'visualizacion_gov',
      label: 'Visualización GOV',
      type: 'text',
      placeholder: 'Información para GOV.CO...',
    },
    {
      name: 'activo',
      label: 'Activo',
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Gestión de Trámites (Test)</h1>
          <p className="text-gray-600">Prueba de la interfaz CRUD de trámites</p>
        </div>
        <Button
          variant="primary"
...
export default TestTramitesPage
